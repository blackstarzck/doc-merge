...
export const TABLE_COLUMNS = [
  {
    ...
    columns: [
      ...
      { name: '연번', key: 'no', type: 'text', width: 100 },
      ...
      { name: '총 권수', key: 'total_bks', type: 'text', width: 100 },
      { name: '기초금액', key: 'base_price', type: 'text', width: 150 },
      { name: '낙찰금액', key: 'win_price', type: 'text', width: 150 },
      { name: '낙찰율(%)', key: 'win_rate', type: 'text', width: 130 },
      { name: '도서정가', key: 'bk_price', type: 'text', width: 150 },
      { name: '도서공급단가', key: 'bk_supply_price', type: 'text', width: 150 },
      ...
      { name: '총입금액', key: 'total_payment', type: 'text' },
      ...
      { name: '자사수익금', key: 'our_revenue', type: 'text' },
