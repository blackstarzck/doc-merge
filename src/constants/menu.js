...
export const TABLE_COLUMNS = [
  {
    ...
    columns: [
      ...
      { name: '날짜', key: 'continue_type', type: 'string', headerTooltip: '"연간"으로 설정한 행은 매출처/매입처에 저장되지 않습니다.', width: 150 },
      ...
      { name: '공고연번', key: 'bid_number', type: 'string' },
  ...
  },
  {
    ...
    columns: [
      ...
      { name: '공고연번', key: 'bid_num', type: 'string' },
  ...
  },
  {
    ...
    columns: [
      ...
      { name: '송장연번', key: 'tracking_number', type: 'string' },
  ...
  },
  {
    ...
    columns: [
      ...
      { name: '구분', key: 'category', type: 'string' },
      { name: '특이사항', key: 'notes', type: 'string' },
      { name: '진행담당', key: 'role_person', type: 'string' },
  ...
  },
  {
    ...
    columns: [
      ...
      { name: '발주일', key: 'order_date', type: 'date' },
      { name: '작성자', key: 'author', type: 'string' },
      { name: '진행업체', key: 'parent_company', type: 'string' },
      ...
      { name: '담당자 전화연번', key: 'manager_phone', type: 'string' },
    ],
  },
  {
    label: '매출처 원장',
