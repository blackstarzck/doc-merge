...
export const TABLE_COLUMNS = [
  ...
  },
  {
    ...
    columns: [
      ...
      { name: '매입처', key: 'vendor_name', type: 'string' },
      { name: '발주일', key: 'order_date', type: 'date' },
      { name: '작성자', key: 'author', type: 'string' },
  ...
  },
  {
    ...
    columns: [
      ...
      { name: '선금날짜', key: 'pre_payment_date', type: 'date' },
      { name: '도서정가', key: 'book_price', type: 'number' },
      { name: '공급율', key: 'supply_rate', type: 'number' },
      { name: '공급가', key: 'supply_price', type: 'number' },
      { name: '입금액', key: 'amount', type: 'number' },
  ...
  },
  {
    ...
    key: 'client_ledger',
    columns: [
      { name: '연번', key: 'serial_number', type: 'number' },
